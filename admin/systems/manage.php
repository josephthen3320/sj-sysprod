...
<head>
    ...
    <title>Manage Service Status</title>
...
<body class="" style="padding-bottom: 32px;">

<div class="w3-bar w3-row w3-margin-bottom theme-dark w3-text-white content-padding" style="height: 60px;">
    <div class="w3-col l6 m6 s12" style="display: flex; align-items: center; height: inherit;">
        <img src="/assets/logo/sysprod_logo_w.png" height="75%">
    </div>

    <div class="w3-col l6 m6 s12 w3-right w3-right-align" style="display: flex; align-items: center; justify-content: right; height: inherit;">
        <b class="w3-large">SYSTEM STATUS</b>
    </div>
</div>
