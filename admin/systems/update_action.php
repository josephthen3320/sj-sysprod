<?php
// update_status.php
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['serviceSubId']) && isset($_POST['newAction'])) {
    ...
    $conn = getConnLog();
    $updateStatusSQL = "UPDATE service_sub SET action = '$newAction', last_updated = '$date' WHERE id = '$serviceSubId'";
