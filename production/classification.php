...
$page_title = "Production Centre | Classification";
...
<div class="w3-threequarter w3-white sj-content" style="min-height: 100vh; margin-left: 25%;">
    ...
    <div style="margin-top: 16px; min-height: 100vh; background-color: #fbfbfb;">
        ...
        <div id="" class="w3-bar w3-white w3-border-bottom " style="display: flex; background-color: #0B293C; height: 72px; align-items: center;">
            <span class="w3-bar-item w3-large" style="color: #0B293C;"><b>Classification Master Data</b></span>
        </div>

        <div class="w3-bar w3-black">
            <button class="w3-bar-item w3-button" onclick="changeIframeSrc('classification/category.php')">Category</button>
            <button class="w3-bar-item w3-button" onclick="changeIframeSrc('classification/subcategory.php')">Subcategory</button>
            <button class="w3-bar-item w3-button" onclick="changeIframeSrc('classification/cmt.php')">CMT</button>
            <button class="w3-bar-item w3-button" onclick="changeIframeSrc('classification/customer.php')">Customer</button>
            <button class="w3-bar-item w3-button" onclick="changeIframeSrc('classification/wash.php')">Wash</button>
            <button class="w3-bar-item w3-button" onclick="changeIframeSrc('classification/brand.php')">Brand</button>
        </div>

        <div class="w3-cell-row w3-padding-16">
            <div id="loading"><i class="fa-solid fa-spinner fa-spin fa-2xl"></i></div>
            <iframe id="myIframe" src="classification/category.php" width="100%" frameborder="0" style="min-height: 75vh;"></iframe>
        </div>
        ...
        <script>
            ...
            // Retrieve the last selected URL from localStorage
            var lastSelectedURL = localStorage.getItem('selectedURL');
            if (lastSelectedURL) {
                showLoadingAnimation();
                iframe.src = lastSelectedURL;
            }
