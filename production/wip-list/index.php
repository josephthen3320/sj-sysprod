...
<div class="w3-threequarter w3-white sj-content" style="min-height: 100vh; margin-left: 25%; padding-bottom: 64px;">
    ...
    <div style="margin-top: 16px; min-height: 100vh; background-color: #fbfbfb;">
        ...
        <div id="" class="w3-bar w3-white w3-border-bottom " style="display: flex; background-color: #0B293C; height: 72px; align-items: center;">
            <span class="w3-bar-item w3-large" style="color: #0B293C;"><b>WIP List</b></span>
        </div>

        <div class="w3-cell-row w3-padding-16">
            <div class="w3-container">
                <button class="w3-button w3-blue" onclick="openPopupURL2('worksheet-table.php')"><i class="fas fa-fw fa-expand"></i>Tampilan Full</button>
                <a href="export-detail.php" class="w3-button w3-green" target="_blank"><i class="fas fa-fw fa-file-download"></i> Export XLSX</a>
            </div>

            <div id="loading">Loading...</div>
            <iframe id="worksheetFrame" src="worksheet-table.php" width="100%" frameborder="0" style="min-height: 85vh;"></iframe>
        </div>
