    ...
    <div class="w3-threequarter w3-white sj-content" style="min-height: 100vh; margin-left: 25%;">
        ...
        <div style="margin-top: 16px; min-height: 100vh; background-color: #fbfbfb">
            ...
            <div id="user-management" class="w3-bar w3-white w3-border-bottom " style="display: flex; background-color: #0B293C; height: 72px; align-items: center;">
                <span class="w3-bar-item w3-large" style="color: #0B293C;"><b>Production Overview</b></span>
            </div>

            <div class="w3-container w3-row w3-padding-16">
                <div class="w3-col l6 m6 s12 w3-padding">
                    <div class=" w3-white w3-card-2">
                        <div class="w3-bar w3-text-white" style=" background-color: #0B293C; padding: 16px 40px;">
                            <h5>
                        ...
                        <div class="w3-container">
                            <iframe src="modules/insight-worksheet.php" width="100%" frameborder="false"></iframe>
                        </div>
                    </div>
                </div>
                ...
                <div class="w3-col l6 m6 s12 w3-padding">
                    <div class=" w3-white w3-card-2">
                        ...
                        <div class="w3-container">
                            <?php include_once 'modules/chart-worksheet.php'; ?>
                        </div>
                    </div>
                </div>
