...
<div class="w3-quarter w3-text-white w3-hide-small" style="min-height: 100vh; position: fixed; background-color: #0B293C">
    <!-- Header -->
    <div class="w3-container w3-padding-16" style="display:flex; justify-content: center; align-items: center; width: 100%; height: 100px;">
    ...
    <div class="w3-padding-16 w3-bar-block" style="">
        ...
        $announcementButton   = '<a class="w3-medium w3-button w3-bar-item action-button" href="/admin/announcement"><i class="fa-solid fa-user w3-text-red"></i> &nbsp;&nbsp; Announcement</a>';
