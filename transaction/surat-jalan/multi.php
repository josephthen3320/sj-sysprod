...
// Check if the selectedRows array is present in the $_POST variable
if (isset($_POST['selectedRows'])) {
    // Retrieve the selectedRows array from the $_POST variable
    ...
    $refWorksheetId = $selectedRows[0]['worksheetId'];
    ...
    foreach ($selectedRows as $sr) {
        $submitData[] = array($sr['transactionId'], $sr['articleId'], $sr['qty']);
    }

    $sjid = createSuratJalanMulti("PM", $source, $destination, $uid, $submitData);
    ...
    // selectedRows array not found in the POST data
    $response = "No selected rows received";
    echo $response;
}
