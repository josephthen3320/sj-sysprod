...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    switch ($processName) {
        case 'embro':
            ...
            pushToEmbro($wid, $cmt, $qty);
            updateWorksheetPosition($wid, 3);   // Set to embro

            // Surat Jalan
            $sjid = createSuratJalan('CT', $transaction_id, 2, 3, $aid, $qty, $uid);
        ...
        case 'print/sablon':
            ...
            // Surat Jalan
            $sjid = createSuratJalan('CT', $transaction_id, 2, 4, $aid, $qty, $uid);
            addSuratJalanRecord($sjid, 'cutting', $transaction_id);
        ...
        case 'sewing':
            ...
            // Surat Jalan
            $sjid = createSuratJalan('CT', $transaction_id, 2, 6, $aid, $qty, $uid);
            addSuratJalanRecord($sjid, 'cutting', $transaction_id);
