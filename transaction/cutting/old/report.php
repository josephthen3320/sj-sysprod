...
<body>
        ...
        <div class="w3-cell-row">
            <h3>Summary</h3>
            <iframe id="frame1" src="report-cutting-by-cmt.php" width="" frameborder="0" style="min-height: ;"></iframe>
        </div>

        <div class="w3-cell-row">
            <h3>Hasil Cutting</h3>
            <iframe id="frame2" src="report-cutting-overview.php" width="100%" frameborder="0"></iframe>
        </div>
