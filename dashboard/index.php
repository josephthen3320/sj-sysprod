        ...
        <div class="w3-container w3-cell-row w3-padding-16">
            ...
            <div class="w3-quarter w3-padding">
                <div class="w3-card-2 w3-white w3-round w3-button w3-cell-row" onclick="openTabURL('https://public.accurate.id/', 'quicklinks')" style="height: 100px; width: 100%;">
                    <div class="w3-container w3-cell w3-cell-middle">
                        AC
                        <!--svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none" preserveAspectRatio="xMidYMid meet">
                            <path d="M37.282 14.4152C36.4893 10.8483 34.3601 7.72071 31.3321 5.67565C28.3041 3.63058 24.6075 2.8235 21.0027 3.42037C17.3979 4.01724 14.1588 5.9727 11.9516 8.88459C9.74439 11.7965 8.73683 15.4434 9.13614 19.0754C9.53545 22.7075 11.3113 26.0484 14.0984 28.4112C16.8856 30.774 20.4721 31.979 24.1205 31.7784C27.7689 31.5779 31.2017 29.987 33.7131 27.3329C36.2244 24.6788 37.6233 21.1633 37.6221 17.5095C37.6216 16.4687 37.5076 15.4311 37.282 14.4152ZM28.0541 25.0638L24.5921 15.4458C23.8917 13.5021 22.7487 13.5021 22.0482 15.4458L18.5862 25.0638C16.7027 24.8337 15.7721 23.3778 16.5075 21.6293L21.8605 8.90198C22.6634 6.99338 23.9768 6.99338 24.7797 8.90198L30.1327 21.6293C30.8682 23.3803 29.9401 24.8337 28.0541 25.0638Z" fill="#991B26"/>
                        </svg-->
                    </div>
                    <div class="w3-container w3-cell w3-cell-middle">
                        <h3><b>Accurate</b></h3>
