...
// Step 2: Retrieve data from the "finishing" table
...
<head>
    ...
    <title>Global finishing Report</title>
...
<table class="w3-table-all w3-small">
    <tr>
        ...
        <th>NO ARTICLE</th>
        <th>MODEL</th>
        <th style="text-align: center">QTY CUTTING</th>
    ...
    */
    ...
    foreach ($data as $cmt_id => $worksheets) {
        ...
        foreach ($worksheets as $worksheet) {
            ...
            $qtyCutting = getCuttingQtyByWorksheetId($worksheet['worksheet_id']);
            ...
            echo "<td style='text-align: center'>" . $qtyCutting . "</td>";
