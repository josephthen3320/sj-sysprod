...
<div class="w3-threequarter w3-white sj-content" style="min-height: 80vh; margin-left: 25%;">
    ...
    <div style="margin-top: 16px; min-height: 95vh; background-color: #fbfbfb;">
        ...
        <div id="" class="w3-bar w3-white w3-border-bottom " style="display: flex; background-color: #0B293C; height: 72px; align-items: center;">
            <span class="w3-bar-item w3-large" style="color: #0B293C;"><b>Laporan Hasil Cutting</b></span>
        </div>

        <div class="w3-container w3-padding-top-24 w3-cell-row">
            <div class="w3-quarter w3-padding">
                <h6>Cutting Report</h6>
                <iframe src="modular/hasil-cutting/global.php" width="100%" height="700px" frameborder="none"></iframe>
            </div>

            <div class="w3-threequarter w3-padding">
                <h6>Rekap Hasil Cutting</h6>
                <iframe src="modular/hasil-cutting/report-detail.php" width="100%" height="700px" frameborder="none"></iframe>
            </div>
        </div>
