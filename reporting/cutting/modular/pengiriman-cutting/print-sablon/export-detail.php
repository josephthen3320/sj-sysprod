...
if ($result->num_rows > 0) {
    ...
    $sheet->setCellValue('B1', "Laporan Pengiriman Hasil Cutting ke Print/Sablon");
    ...
    $file_name = 'laporan_kirim_hasil_cutting_ke_print-sablon_'. $currentDate . '.xlsx'; // Change the file name as needed
